...
<script>
    $(function(){
        /*$(".portlet-datatable").on( "click", '.courierMan', function() {
            ...
            $('<form action="OrderManagement/assignCourierMan" method="post"><input type="hidden" name="orderId" value="'+OrderId+'"><input type="hidden" name="CMID" value="'+CMID+'"></form>').appendTo('body').submit();
        });*/
