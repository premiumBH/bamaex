...
<div class="row">
    ...
    <div class="col-md-12"><a href="<?= CTRL ?>user/create"><input value="Create User" class="btn green" type="button"></a><br/><br/>
                        ...
                        if (isset($result1['users'])) {
                            foreach ($result1['users'] AS $result) {?>
                                <tr>
                                    ...
                                    <td>
                                    <a href="<?php echo   CTRL; ?>user/create?edit-id=<?php echo  $result->intUserId ; ?>" class="btn red">Edit</a>
                                    ...
                                    <a href=" <?php echo   CTRL ; ?>user/changeStatus/<?php echo $result->intUserId; ?>/1" class="btn red">Unsuspend </a>
                                     <?php }?>
                                    <a href=" <?php echo   CTRL ; ?>user/delete/<?php echo $result->intUserId; ?>" class="btn red">Delete</a>
                                    </td>
                                </tr>
