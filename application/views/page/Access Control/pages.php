...
<div class="row">
    <div class="col-md-12">
        <a href="<?=CTRL?>page/create"><input value="Create Page" class="btn green" type="button"></a><br /><br />
                    ...
                    if($result1['status'] = 'true')
                    {
                        ...
                        <form action="<?=CTRL?>pages" method="POST" autocomplete="off">
                            ...
                            foreach($result1['pages'] AS $result)
                            {
                                ...
                                <?php foreach($userType as $userTypeIn){?>
                                <td>
                                    <!--<input class="icheck" name="<?php /*echo $userTypeIn->varUserTypeName;*/?>[][<?php /*echo $userTypeIn->intUserTypeId*/?>]" value="<?php /*echo $result->Id;*/?>" type="checkbox"
                                    --><?php /*if(in_array($userTypeIn->intUserTypeId,$result->pageAccessUserIds)){
                                        echo 'checked="checked"';
                                    }*/?>
                                    <input class="icheck" name="<?php echo $userTypeIn->intUserTypeId;?>[][<?php echo $userTypeIn->intUserTypeId?>]" value="<?php echo $result->Id;?>" type="checkbox"
                                    <?php if(in_array($userTypeIn->intUserTypeId,$result->pageAccessUserIds)){
                                        echo 'checked="checked"';
                                    }?>
                                    >
