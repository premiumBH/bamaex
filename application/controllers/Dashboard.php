        ...
        if($this->input->post('submit') != null)
        {
            ...
            for ($row = 1; $row <= $highestRow; $row++){
                ...
                else
                {
                    ...
                    $weight_per_price = $this->db->where('client_id' , $client_id)->get('client_table')->result()[0]->weight_per_price;
        ...
        else if($this->input->post('orderData') != null)
        {
            ...
            while ($this->input->post('row_' . $itr) != null)
            {
                ...
                if($itr == 0)
                {
                    ...
                    $address_line = "MENA 360  DWC-LLC";
                    $address = "Mezzannine Floor";
                    $address2 = "Mezzannine Floor Plot # 5,6,7";
                    $city = "DWC DUBAI , UAE";
                    $mobile = "0322 9815923";
